export { default as AttitudeIndicator } from './AttitudeIndicator.svelte';
export { default as SpeedTape } from './SpeedTape.svelte';
export { default as AltitudeTape } from './AltitudeTape.svelte';
export { default as VSI } from './VSI.svelte';
export { default as HeadingTape } from './HeadingTape.svelte';
